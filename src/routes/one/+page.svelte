...
<p>
	When you tap the link to this page, Turbo proposes a visit to the app to decide how to handle the
	URL. In this case, it chooses to present a Turbo-based web screen. Go back and try Intercept with
	a native view to see how to load a native screen instead.
</p>
